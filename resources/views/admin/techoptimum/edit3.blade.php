...
<div class="content-body">
	<div class="container-fluid">
		...
		<div class="col-lg-12 pt-2">
			...
			<h4 class="card-title">Edit Techoptimum Books <a href="{{ url('managetechoptimumbooks') }}" class="float-right btn btn-dark btn-sm">Manage Techoptimum Books</a></h4><br>

			<div class="card">
				<div class="card-body">
					<div class="basic-form border p-5">
						<form method="post" class="row" action="{{ url("updatetechoptimumbooks/".$data->id) }}" enctype="multipart/form-data">
							...
							<div class="col-md-12 row">
								...
								<div class="form-group col-md-6">
									...
									<a href="{{  asset($data->file) }}" download="" class="btn btn-success">Download</a>
