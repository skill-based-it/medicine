...
<div class="content-body">
	<div class="container-fluid">
		...
		<div class="col-lg-12 pt-2">
			...
			<h4 class="card-title">Add Blogs <a href="{{ url('manageblogs') }}" class="float-right btn btn-dark btn-sm">Manage Blogs</a></h4><br>

			<div class="card">
				<div class="card-body">
					<div class="basic-form border p-5">
						<form method="post" class="row" action="{{ url("insertblogs") }}" enctype="multipart/form-data">
