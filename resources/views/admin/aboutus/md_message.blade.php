			...
			<div class="card">
				<div class="card-body">
					<div class="basic-form border p-5">
						<form method="post" class="row" action="{{ url("updateMdMessage") }}" enctype="multipart/form-data">
							...
							<div class="col-md-12 row">
								...
								<div class="form-group col-md-6">
									...
									<input type="file" name="md_image" class="form-control" id="imgInp">
                                    <img src="{{asset('backend/mdImage')}}/{{$data->md_image}}" style="max-width: 120px;" class="img-fluid">
								</div>
