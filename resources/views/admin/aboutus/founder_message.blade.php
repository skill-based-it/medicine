...
<div class="content-body">
	<div class="container-fluid">
		...
		<div class="col-lg-12 pt-2">
			...
			<h4 class="card-title">Founder Message </h4><br>

			<div class="card">
				<div class="card-body">
					<div class="basic-form border p-5">
						<form method="post" class="row" action="{{ url("updateFounderMessage") }}" enctype="multipart/form-data">
							...
							<div class="col-md-12 row">
								...
								<div class="form-group col-md-6">
									...
									<input type="file" name="founder_image" class="form-control" id="imgInp">
                                    <img src="{{asset('backend/founderImage')}}/{{$data->founder_image}}" style="max-width: 120px;" class="img-fluid">
								</div>
