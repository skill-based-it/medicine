			...
			<div class="card">
				<div class="card-body">
					<div class="basic-form border p-5">
						<form method="post" class="row" action="{{ url("updateagent_review") }}/{{$data->id}}" enctype="multipart/form-data">
							...
							<div class="col-md-12 row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="agent_name" class="form-control" required="" value="{{$data->agent_name}}">
                                </div>

                                <div class="form-group col-md-4">
                                    <label>Designation: <span class="text-danger">*</span></label>
                                    <input type="text" name="designation" class="form-control" required="" value="{{$data->designation}}">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <img src="{{asset('backend/agentImage')}}/{{$data->image}}" alt="" class="img-fluid" style="max-width: 80px;">
								</div>
