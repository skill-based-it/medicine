...
<div class="content-body">
	<div class="container-fluid">
		...
		<div class="col-lg-12 pt-2">
			...
			<h4 class="card-title">Work Place Information</h4><br>

			<div class="card">
				<div class="card-body">
					<div class="basic-form border p-5">
						<form method="post" class="row" action="{{ url("updateWorkplaceInfo") }}" enctype="multipart/form-data">
							...
							<div class="col-md-12 row">
								...
								<div class="form-group col-md-6">
                                    ...
                                    @if($workimage)
                                    @foreach ($workimage as $v)
                                    <img src="{{asset('backend/workplaceImage')}}/{{$v->images}}" alt="" class="img-fluid" style="float: left;max-width:120px;">
                                    @endforeach
                                    @endif
								</div>
