...
<div class="content-body">
	<div class="container-fluid mt-3">
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Sub Categories <a href="{{ url('managesubcategories') }}" class="float-right btn btn-dark btn-sm">Manage Sub Categories</a></h4><br>
					<div class="basic-form">
						<form method="post" class="row" action="{{ url("insertsubcategories") }}" enctype="multipart/form-data">
