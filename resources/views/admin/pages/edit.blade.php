...
<div class="content-body">
	<div class="container-fluid mt-3">
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Edit Page</h4><br>
					<div class="basic-form">
						<form method="post" class="row" action="{{ url("updatepages/".$data->id) }}" enctype="multipart/form-data">
							...
							<div class="form-group col-md-12">
								<label>Details:</label>
								<textarea rows="4" class="form-control summernote" name="details">{{ $data->details }}</textarea>
							</div>
							...
							<div class="form-group col-md-12 row">
								...
								<div class="col-md-9">
									<label class="container">Footer
										<input type="radio" name="location" value="2" <?php if ($data->location == 2) {
											echo "checked";
										} ?>>
									...
									<label class="container">Top Menu
										<input type="radio" name="location" value="1" <?php if ($data->location == 1) {
											echo "checked";
										} ?>>
										<span class="checkmark"></span>
									</label>
							...
							<div class="form-group col-md-12 row">
								...
								<div class="col-md-9">
									...
									<label class="container">Inactive
										<input type="radio" name="status" value="0"  <?php if ($data->status == 0) {
											echo "checked";
										} ?>>
										<span class="checkmark"></span>
									</label>
