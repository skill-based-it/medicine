            ...
            <div class="nk-sidebar">           
              <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                  ...
                  <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                      <i class="icon-grid menu-icon"></i><span class="nav-text">Blog Info.</span>
                    </a>
                    <ul aria-expanded="false">
                      <li><a href="{{ url('/addblogs')}}">Blogs</a></li>
                      <li><a href="{{ url('/manageblogs')}}">Manage Blogs</a></li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a href="{{ url("addcontact") }}" aria-expanded="false">
                      <i class="icon-settings menu-icon"></i><span class="nav-text">Contact</span>
                    </a>
                  </li>

                  <li>
                    <a href="{{ url("addservices") }}" aria-expanded="false">
                      <i class="icon-settings menu-icon"></i><span class="nav-text">Supports</span>
                    </a>
                  </li>
